                            ...
                            : OpInputMap(node, gates_count)
                        {
                            ...
                            if (linear_before_reset)
                            {
                                ...
                                if (ng_inputs.size() > 3 && !ngraph::op::is_null(ng_inputs.at(3)))
                                {
                                    ...
                                    const auto wr_z_bias =
                                            std::make_shared<ngraph::op::v1::Add>(split_bias.at(0), split_bias.at(3));
                                    const auto wr_r_bias =
                                            std::make_shared<ngraph::op::v1::Add>(split_bias.at(1), split_bias.at(4));
