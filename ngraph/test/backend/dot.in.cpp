...
//         63162.,  63960.])
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_4d_5d_multi_axis)
{
...
// array([ 251412.,  254040.])
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_4d_5d_multi_axis_more)
{
    vector<float> a_data(2 * 3 * 3 * 4);
    for (int i = 0; i < 2 * 3 * 3 * 4; i++)
    {
...
//
NGRAPH_TEST(DISABLED_${BACKEND_NAME}, DISABLED_dot_4d_5d_multi_axis_big_fp64_VERY_SLOW)
{
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_0_0)
{
    Shape shape{0};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_2x0_0x2)
{
    Shape shape_a{2, 0};
    Shape shape_b{0, 2};
    Shape shape_r{2, 2};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_0x2_2x0)
{
    Shape shape_a{0, 2};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_3x2_2x0)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_scalar_0x2)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{0, 2};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_2x0_0)
{
    Shape shape_a{2, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{0};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot1d)
{
    Shape shape{4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot2d)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot2d_non_square)
{
    Shape shape_in1{2, 3};
    Shape shape_in2{3, 3};
    Shape shape_out{2, 3};
...
//          [ 77.,  92.]]]])
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot3d_3d)
{
    Shape shape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
//         [ 272.,  338.,  404.,  470.]]])
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot3d_2d)
{
    Shape shape_a{4, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{3, 4};
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_scalar_tensor_arg0)
{
    Shape shape_a{};
    Shape shape_b{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_scalar_tensor_arg1)
{
    Shape shape_a{2, 2, 2};
    Shape shape_b{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_scalar_scalar)
{
    Shape shape{};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_vector_4_3)
{
    Shape shape_a{4, 3};
    Shape shape_b{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_vector)
{
    Shape shape_a{4, 4};
    Shape shape_b{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_matrix_vector_int64)
{
    Shape shape_a{4, 4};
    Shape shape_b{4};
...
//         7708.,  7930.])
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_3d_multi_axis)
{
...
//
NGRAPH_TEST(${BACKEND_NAME}, DISABLED_dot_3d_one_axis_arbitrary)
{
