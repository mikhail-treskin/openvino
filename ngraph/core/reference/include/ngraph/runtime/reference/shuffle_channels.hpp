    ...
    namespace runtime
    {
        namespace reference
        {
                                  ...
                                  const size_t& elem_size)
            {
                ...
                // first reshape from data_shape to reshaped_out_shape is skipped since it doesn't
                // affect out data
                ...
                auto axis_vector =
                    AxisVector{begin(transpose_axes_order), end(transpose_axes_order)};
                runtime::opt_kernel::reshape(
                    data, output, reshaped_out_shape, axis_vector, transposed_shape, elem_size);
                // last reshape from transposed_shape to data_shape is skipped since it doesn't
                // affect out data
            }
        }
    }
