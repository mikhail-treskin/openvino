    ...
    namespace runtime
    {
        namespace reference
        {
                                ...
                                const size_t& elem_size)
            {
                ...
                begins.assign(crops_begin_values,
                              crops_begin_values + shape_size(crops_begin_shape));
                ...
                SlicePlan slice_plan = make_slice_plan(data_shape,
                                                       ...
                                                       AxisSet(),
                                                       AxisSet());
                runtime::reference::strided_slice(data, output, data_shape, slice_plan, elem_size);
            }
        }
    }
}
